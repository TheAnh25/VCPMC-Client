...
const DetailDistributor: React.FC = () => {
  const { id } = useParams();
  const [detailDistributor, setDetailDistributor] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setDetailDistributor(res.data);
        setNameContract(res.data[0].number);
        setNameRecord(res.data[0].record);
      })
      .catch((err) => {
        console.log(err);
      });
            ...
            <div className="ml-[60px] flex flex-col gap-6">
              <div className="flex flex-col gap-[2px]">
                ...
                <span className="text-[#FFFFFF] text-4xl font-bold">
                  Hợp đồng Ủy quyền {nameContract}
                </span>
              </div>
              ...
              <div className="flex gap-10 justify-between ">
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col gap-7">
                    ...
                    <span className="text-2xl font-bold text-[#FFAC69]">
                      {nameRecord}
                    </span>
                    <div className="bg-[#2F2F41] h-[472px] flex flex-col justify-between gap-[50px] rounded-2xl">
                      {/* Table List Record */}
